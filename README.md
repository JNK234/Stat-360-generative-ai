...
| Week 6, Thursday    | February 13| Prompt optimization, reflection, steering   | Read in chronological order: [Toy Models of Superposition](https://transformer-circuits.pub/2022/toy_model/index.html), [Monosemantic Features](https://transformer-circuits.pub/2023/monosemantic-features/index.html), [Scaling Monosemanticity](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html) |
| Week 7, Tuesday   | February 18| GPTo1, LLMS + Tabular ML | [DeepSeek Math](https://arxiv.org/pdf/2402.03300), [DeepSeek-R1](https://arxiv.org/pdf/2501.12948), [Open-R1(1)](https://huggingface.co/blog/open-r1/update-1), [Open R1(2)](https://huggingface.co/blog/open-r1/update-2)
